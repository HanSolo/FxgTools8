...
class FxgTranslator {
    ...
    private String javaFxPropertyDeclaration(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                PROPERTY_CODE.append("default").append(PROPERTY_NAME.capitalize()).append(" = ").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append(";\n")
                ...
                PROPERTY_CODE.append("default").append(PROPERTY_NAME.capitalize()).append(" = ").append(defaultValue).append(";\n")
                // Add the property definition
    ...
    private String javaFxPropertyGetterSetter(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? default").append(PROPERTY_NAME.capitalize()).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                ...
                PROPERTY_CODE.append("            default").append(PROPERTY_NAME.capitalize()).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleDoubleProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleFloatProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("boolean")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleBooleanProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("int")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleIntegerProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("byte")) {
                PROPERTY_CODE.append("\n    ").append("public final byte get").append(PROPERTY_NAME.capitalize()).append("() {\n")
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? default").append(PROPERTY_NAME.capitalize()).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final byte ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            default").append(PROPERTY_NAME.capitalize()).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyByteProperty " : "ByteProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleByteProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("long")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleLongProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("string")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleStringProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("object")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleObjectProperty(this, \"").append(PROPERTY_NAME).append("\", default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else {
    ...
    private String javaFxBuildMethod(final String CLASS_NAME, final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        BUILD_CODE.append("                CONTROL.setMinHeight(((DoubleProperty) properties.get(key)).get());\n")
        ...
        BUILD_CODE.append("                CONTROL.setMaxWidth(((DoubleProperty) properties.get(key)).get());\n")
        BUILD_CODE.append("            } else if(\"maxHeight\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setMaxHeight(((DoubleProperty) properties.get(key)).get());\n")
        ...
        BUILD_CODE.append("                CONTROL.setTranslateX(((DoubleProperty) properties.get(key)).get());\n")
        BUILD_CODE.append("            } else if (\"translateY\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setTranslateY(((DoubleProperty) properties.get(key)).get());\n")
