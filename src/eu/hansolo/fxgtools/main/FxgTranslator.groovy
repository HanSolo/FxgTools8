...
class FxgTranslator {
                    ...
                    if (!element.shape.effects.isEmpty() && element.shape.effects.size() > 1) {
                        ...
                        element.shape.effects.each { Effect effect ->
                            if (effect.class.equals(InnerShadow.class)) {
                                ...
                                regionInitialization.append("\n        ${varName}InnerShadow${effectCounter}.setRadius(${((InnerShadow) effect).radius} / ${element.shape.referenceWidth} * PREFERRED_WIDTH);")
                                ...
                                regionInitialization.append("\n        ${varName}DropShadow${effectCounter}.setRadius(${((DropShadow) effect).radius} / ${element.shape.referenceWidth} * PREFERRED_WIDTH);")
    ...
    private String javaFxPropertyDeclaration(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                PROPERTY_CODE.append("    private double ")
                appendBlanks(PROPERTY_CODE, (maxLength + 9))
                PROPERTY_CODE.append("_").append(PROPERTY_NAME).append(" = ").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append(";\n")
                ...
                // Add the default value
                PROPERTY_CODE.append("    private int ")
                appendBlanks(PROPERTY_CODE, (maxLength + 9))
                PROPERTY_CODE.append("_").append(PROPERTY_NAME).append(" = ").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append(";\n")
                // Add the property definition
                ...
                // Add the default value
                PROPERTY_CODE.append("    private String ")
                appendBlanks(PROPERTY_CODE, (maxLength + 9))
                PROPERTY_CODE.append("_").append(PROPERTY_NAME).append(" = \"").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append("\";\n")
                // Add the property definition
                ...
                // Add the default value
                PROPERTY_CODE.append("    private Object ")
                appendBlanks(PROPERTY_CODE, (maxLength + 7))
                PROPERTY_CODE.append("_").append(PROPERTY_NAME).append(" = ").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append(";\n")
                // Add the property definition
                ...
                // Add the default value
                PROPERTY_CODE.append("    private ${PROPERTIES.get(PROPERTY_NAME).type} ")
                appendBlanks(PROPERTY_CODE, (maxLength + 9))
                ...
                PROPERTY_CODE.append("_").append(PROPERTY_NAME).append(" = ").append(defaultValue).append(";\n")
                // Add the property definition
                PROPERTY_CODE.append("    private ObjectProperty<${PROPERTIES.get(PROPERTY_NAME).type}> ")
                PROPERTY_CODE.append(PROPERTY_NAME).append(";\n")
            }
        }
        PROPERTY_CODE.append("    private boolean         ");
        appendBlanks(PROPERTY_CODE, (maxLength + 1))
    ...
    private String javaFxPropertyGetterSetter(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            final String  TYPE      = PROPERTIES.get(PROPERTY_NAME).type.toLowerCase()
            final boolean READ_ONLY = PROPERTIES.get(PROPERTY_NAME).readOnly;
            if (TYPE.equals("double")) {
                PROPERTY_CODE.append("\n    ").append("public final double get").append(PROPERTY_NAME.capitalize()).append("() {\n")
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final double ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyDoubleProperty " : "DoubleProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleDoubleProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("float")) {
                PROPERTY_CODE.append("\n    ").append("public final float get").append(PROPERTY_NAME.capitalize()).append("() {\n")
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final float ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyFloatProperty " : "FloatProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleFloatProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("boolean")) {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final boolean ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyBooleanProperty " : "BooleanProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleBooleanProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("int")) {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final int ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyIntegerProperty " : "IntegerProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleIntegerProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("long")) {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final long ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyLongProperty " : "LongProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleLongProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("string")) {
                ...
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyStringProperty " : "StringProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleStringProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("object")) {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final Object ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyObjectProperty " : "ObjectProperty ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleObjectProperty(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else {
                ...
                PROPERTY_CODE.append("        return (null == ").append(PROPERTY_NAME).append(") ? _").append(PROPERTY_NAME).append(" : ").append(PROPERTY_NAME).append(".get();\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append(READ_ONLY ? "private" : "public").append(" final void set").append(PROPERTY_NAME.capitalize()).append("(final ${ORIGINAL_TYPE} ").append(PROPERTY_NAME.toUpperCase()).append(") {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            _").append(PROPERTY_NAME).append(" = ").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("        } else {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
                PROPERTY_CODE.append("    ").append("public final ").append(READ_ONLY ? "ReadOnlyObjectProperty<${ORIGINAL_TYPE}>" : "ObjectProperty<${ORIGINAL_TYPE}> ").append(PROPERTY_NAME).append("Property() {\n")
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleObjectProperty<>(this, \"").append(PROPERTY_NAME).append("\", _").append(PROPERTY_NAME).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
    ...
    private String javaFxBuildMethod(final String CLASS_NAME, final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        BUILD_CODE.append("        properties.forEach((key, property) -> {\n")
        BUILD_CODE.append("            if (\"minSize\".equals(key)) {\n")
        BUILD_CODE.append("                Dimension2D dim = ((ObjectProperty<Dimension2D>) property).get();\n")
        BUILD_CODE.append("                CONTROL.setMinSize(dim.getWidth(), dim.getHeight());\n")
        BUILD_CODE.append("            } else if (\"prefSize\".equals(key)) {\n")
        BUILD_CODE.append("                Dimension2D dim = ((ObjectProperty<Dimension2D>) property).get();\n")
        BUILD_CODE.append("                CONTROL.setPrefSize(dim.getWidth(), dim.getHeight());\n")
        BUILD_CODE.append("            } else if (\"maxSize\".equals(key)) {\n")
        BUILD_CODE.append("                Dimension2D dim = ((ObjectProperty<Dimension2D>) property).get();\n")
        BUILD_CODE.append("                CONTROL.setMaxSize(dim.getWidth(), dim.getHeight());\n")
        BUILD_CODE.append("            } else if(\"minWidth\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setMinWidth(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if(\"minHeight\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setMinHeight(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if(\"prefWidth\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setPrefWidth(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if(\"prefHeight\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setPrefHeight(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if(\"maxWidth\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setMaxWidth(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if(\"maxHeight\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setMaxHeight(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"layoutX\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setLayoutX(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"layoutY\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setLayoutY(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"translateX\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setTranslateX(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"translateY\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setTranslateY(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"scaleX\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setScaleX(((DoubleProperty) property).get());\n")
        BUILD_CODE.append("            } else if (\"scaleY\".equals(key)) {\n")
        BUILD_CODE.append("                CONTROL.setScaleY(((DoubleProperty) property).get());\n")
        ...
        if (PROPERTIES.keySet().isEmpty()) {
            ...
            PROPERTIES.keySet().each{String PROPERTY_NAME->
                ...
                if (TYPE.equals("double")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((DoubleProperty) property).get());\n")
                } else if (TYPE.equals("boolean")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((BooleanProperty) property).get());\n")
                } else if (TYPE.equals("int")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((IntegerProperty) property).get());\n")
                } else if (TYPE.equals("long")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((LongProperty) property).get());\n")
                } else if (TYPE.equals("string")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((StringProperty) property).get());\n")
                } else if (TYPE.equals("object")) {
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((ObjectProperty) property).get());\n")
                } else {
                    final String ORIGINAL_TYPE = PROPERTIES.get(PROPERTY_NAME).type
                    BUILD_CODE.append("                CONTROL.set").append(PROPERTY_NAME.capitalize()).append("(((ObjectProperty<${ORIGINAL_TYPE}>) property).get());\n")
                }
            }
            BUILD_CODE.append("            }\n")
        }
