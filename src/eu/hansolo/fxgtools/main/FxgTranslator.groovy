    ...
    private String javaFxPropertyDeclaration(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                appendBlanks(PROPERTY_CODE, (maxLength - 3))
                ...
                appendBlanks(PROPERTY_CODE, (maxLength))
                PROPERTY_CODE.append("DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(" = ").append(PROPERTIES.get(PROPERTY_NAME).defaultValue).append(";\n")
                // Add the property definition
    ...
    private String javaFxPropertyGetterSetter(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                PROPERTY_CODE.append("        return (null != ").append(PROPERTY_NAME).append(") ").append(PROPERTY_NAME).append(".get() : DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(";\n")
                PROPERTY_CODE.append("    }\n")
                ...
                PROPERTY_CODE.append("        if ((null != ").append(PROPERTY_NAME).append(") || (").append("DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(" != ").append(PROPERTY_NAME).append(".get())) {\n")
                ...
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleDoubleProperty(this, \"").append(PROPERTY_NAME).append("\", DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleBooleanProperty(this, \"").append(PROPERTY_NAME).append("\", DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("int")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleIntegerProperty(this, \"").append(PROPERTY_NAME).append("\", DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("long")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleLongProperty(this, \"").append(PROPERTY_NAME).append("\", DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("string")) {
                ...
                PROPERTY_CODE.append("        if (null == ").append(PROPERTY_NAME).append(") {\n")
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(" = new SimpleStringProperty(this, \"").append(PROPERTY_NAME).append("\", DEFAULT_").append(PROPERTY_NAME.toUpperCase()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("        return ").append(PROPERTY_NAME).append(";\n")
                PROPERTY_CODE.append("    }\n")
            } else if (TYPE.equals("object")) {
