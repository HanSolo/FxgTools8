    ...
    private String javaFxPropertyGetterSetter(final HashMap<String, FxgVariable> PROPERTIES) {
        ...
        PROPERTIES.keySet().each{String PROPERTY_NAME->
            ...
            if (TYPE.equals("double")) {
                ...
                PROPERTY_CODE.append("        return (null != ").append(PROPERTY_NAME).append(") ").append(PROPERTY_NAME).append(".get() : default").append(PROPERTY_NAME.capitalize()).append(";\n")
                PROPERTY_CODE.append("    }\n")
                ...
                PROPERTY_CODE.append("            ").append(PROPERTY_NAME).append(".set(default").append(PROPERTY_NAME.capitalize()).append(");\n")
                PROPERTY_CODE.append("        }\n")
                PROPERTY_CODE.append("    }\n")
